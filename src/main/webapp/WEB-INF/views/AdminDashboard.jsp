												...
												<div class="col-md-5">
													<ul
														...
														<li class="nav-item"><a class="nav-link active"
															...
															href="#pills-health" role="tab"
															aria-controls="pills-home" aria-selected="true"> Day
														</a></li>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													<td class="py-1"><img src="images/faces/face1.jpg"
														alt="image" /></td>
													<td>Herman Beck</td>
													<td>
														<div class="progress">
												...
												<tr>
													<td class="py-1"><img src="images/faces/face5.jpg"
														alt="image" /></td>
													<td>Edward</td>
													<td>
														<div class="progress">
												...
												<tr>
													<td class="py-1"><img src="images/faces/face6.jpg"
														alt="image" /></td>
													<td>John Doe</td>
													<td>
														<div class="progress">
												...
												<tr>
													<td class="py-1"><img src="images/faces/face7.jpg"
														alt="image" /></td>
													<td>Henry Tom</td>
													<td>
														<div class="progress">
								...
								<div class="card-body py-5">
									<div
										...
										<div class="ms-3 ml-md-0 ml-xl-3">
											...
											<p class="mt-2 text-white card-text">You main list
												growing</p>
										</div>
									</div>
								</div>
						...
						<div class="card-body">
							<div
								...
								<span
									...
									the best <a href="https://www.bootstrapdash.com/"
