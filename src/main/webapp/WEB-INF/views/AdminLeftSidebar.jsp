    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="enrollmentMenu">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="newEnrollment">New Enrollment</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="pages/charts/chartjs.html">
        ...
        <li class="nav-item"><a class="nav-link" href="pages/icons/mdi.html">
        ...
        <li class="nav-item"><a class="nav-link" href="docs/documentation.html">
            <i class="mdi mdi-file-document-box-outline menu-icon"></i>
            <span class="menu-title">Documentation</span>
        </a></li>

        <li class="nav-item"><a class="nav-link" href="https://www.bootstrapdash.com/product/spica-admin/">
