<nav class="sidebar sidebar-offcanvas" id="sidebar">
	<ul class="nav">
		...
		<li class="nav-item"><a class="nav-link" href="/admin-dashboard">
				<i class="mdi mdi-view-quilt menu-icon"></i> <span
		...
		<li class="nav-item"><a class="nav-link"
			...
			<div class="collapse" id="batchTimeMenu">
				<ul class="nav flex-column sub-menu">
					<li class="nav-item"><a class="nav-link" href="newBatchTime">New
							Batch Time</a></li>
					<li class="nav-item"><a class="nav-link" href="listBatchTime">List
							Batch Time</a></li>
				</ul>
			</div></li>
