											...
											<table
												...
												<tbody>
													<c:forEach var="student" items="${students}">
														<tr>
															<!-- Student Name -->
															<td class="align-middle">${student.user.firstName}
