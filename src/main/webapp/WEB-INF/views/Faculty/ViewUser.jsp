...
<div class="container mt-5 mb-5">
    ...
    <div class="text-center mt-4">
        <a href="editUser" class="btn btn-warning me-2">Edit My Profile Data</a>
        <a href="editUserProfilePic" class="btn btn-info me-2">Edit My Profile Picture</a>
        <a href="deleteUser" class="btn btn-danger me-2"
           onclick="return confirm('Are you sure you want to delete this user?');">Delete My Profile</a>
        <a href="faculty-dashboard" class="btn btn-secondary">Back to Faculty Dashboard</a>
    </div>
