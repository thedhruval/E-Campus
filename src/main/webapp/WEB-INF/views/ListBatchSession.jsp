...
<body>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="table-responsive">
										<table id="listBatchSessionTable"
											...
											<tbody>
												<c:forEach var="session" items="${batchSessions}">
													<tr>
														...
														<td>${session.faculty.firstName}
															${session.faculty.lastName}</td>
														<td><a
															href="editBatchSession?batchSessionId=${session.batchSessionId}"
															class="btn btn-warning btn-sm">Edit</a> <a
															href="deleteBatchSession?batchSessionId=${session.batchSessionId}"
	...
	<script>
		$(document).ready(function() {
			$('#listBatchSessionTable').DataTable({
